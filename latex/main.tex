...
%
%%%%%%%%%%% DOCUMENT DATA %%%%%%%%%%%%
\newcommand{\project}{Estudio del efecto de la deriva de sensores para gases en modelos de ML}
\newcommand{\projectshort}{Short Title}
\newcommand{\authorname}{Daniel García Teba}
\newcommand{\tutoredby}{Miguel Ángel Gómez López}
...
\begin{document}
	...
	\bibliography{Bibliography/mubib}
	%
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
